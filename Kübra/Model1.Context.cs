...
namespace Kübra
{
    ...
    public partial class DbTeknikServisEntities : DbContext
    {
        ...
        public virtual DbSet<MUSTERIHAREKETLER> MUSTERIHAREKETLER { get; set; }
        ...
        public virtual DbSet<TBLPERSONELHAREKETLİLİK> TBLPERSONELHAREKETLİLİK { get; set; }
        ...
        public virtual ObjectResult<MAXKATEGORI_Result> MAXKATEGORI()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<MAXKATEGORI_Result>("MAXKATEGORI");
        }
    
        public virtual ObjectResult<string> MAXKATEGORI1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("MAXKATEGORI1");
        }
        ...
        public virtual ObjectResult<Musterihareketler1_Result> Musterihareketler1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Musterihareketler1_Result>("Musterihareketler1");
        }
